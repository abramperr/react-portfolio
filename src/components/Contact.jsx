...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-gradient-to-b text-white from-black p-4  via-[#2D033B] to-[#540375] '>
        <div className='max-w-screen-lg flex flex-col mx-auto justify-center w-full h-full pt-20'>
            <div className='pb-8'>
